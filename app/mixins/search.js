...
module.exports = {
  methods: {
    ...
    searchCards: function(userID, searchText, hitsPerPage) {
      const d = Q.defer()
      const params = {
        query: searchText,
    ...
    compoundSearch: function(userID, searchText) {
      const d = Q.defer()
      const self = this;
      const maxLength = 400;
    ...
    checkPageHit: function(pageData, results) {
    ...
    checkPageReminder: function(userID, pageData) {
      const d = Q.defer()
      const params = {
        query: '',
    ...
    getPageResults: function(userID, pageData) {
      const d = Q.defer()
      // Gets all results
      const self = this;
      const pageResults = {};
